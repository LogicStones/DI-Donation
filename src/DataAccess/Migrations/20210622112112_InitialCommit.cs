        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionFees = table.Column<float>(nullable: false),
                    isFeeInclusive = table.Column<bool>(nullable: false),
                    ReferenceTransactionId = table.Column<string>(maxLength: 500, nullable: false),
                    TimeStamp = table.Column<DateTime>(nullable: false),
                    SponsorFirstName = table.Column<string>(maxLength: 256, nullable: true),
                    SponsorLastName = table.Column<string>(maxLength: 256, nullable: true),
                    SponsorAddress = table.Column<string>(maxLength: 256, nullable: true),
                    SponsorPostCode = table.Column<string>(maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
